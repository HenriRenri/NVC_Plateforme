...
@section('content')
    <div class="container mx-auto mt-10">
        ...
        @if (session('delete_success'))
            <div class="bg-green-100 border border-red-400 text-red-700 text-center px-4 py-3 rounded relative mt-4" role="alert">
        ...
        <table class="table-auto w-full border-collapse border border-gray-300 mt-5">
            ...
            <tbody class="text-center">
                @foreach ($categories as $categori)
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2 ">
                            ...
                            <div class="text-red-400">
                                <button id="deleteButton-{{$categori->name}}" data-modal-target="deleteModal" data-modal-toggle="deleteModal-{{$categori->name}}"  type="button">
                    ...
                    <!-- Delete modal -->
                    <div id="deleteModal-{{$categori->name}}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                            <!-- Modal content -->
                            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                <button type="button" class="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="deleteModal-{{$categori->name}}">
                                ...
                                <p class="mb-4 text-gray-500 dark:text-gray-300">Are you sure you want to delete the categori "{{$categori->name}}" ?</p>
                                <div class="flex justify-center items-center space-x-4">
                                    ...
                                    <form action="{{ route('categories_delete', $categori->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
